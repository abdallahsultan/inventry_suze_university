            ...
            <div class="vertical-align-middle">
                <div class="auth-box ">
                    <div class="left">
                        <div class="content">
                            <div class="header">
                                <div class="logo text-center"><img style="    width: 50%;" src="{{asset('assets/img/logo.png')}}" alt="IMS Logo"></div>
                            ...
                            <form class="form-auth-small" method="POST" action="{{ route('login') }}">
                                ...
                                <button type="submit" class="btn btn-linear btn-lg btn-block">LOGIN</button>
                                <!-- <div class="bottom">
                    ...
                    <div class="right">
                        ...
                        <div class="content text">
                            <h1 class="heading"> this is an inventory management software at Suez University
we are more than just company</h1>
                        </div>
                    </div>
