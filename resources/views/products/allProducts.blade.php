...
@section('content')
    <div class="box box-success">
        ...
        <div class="box-header">
            <h3 class="box-title"> faculties products inquiries </h3>
...
@section('bot')
    ...
    <script type="text/javascript">
        var table = $('#products-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('api.faculties_products_inquiries') }}",
            columns: [
                {data: 'id', name: 'id'},
                {data: 'name', name: 'name'},
                {data: 'type', name: 'type'},
...
$('#kt_datatable_search_query1').change(function() {
    if($('#kt_datatable_search_query1 option:selected').html() == '-- Choose Category --'){
        $('#products-table').DataTable().column(4).search('').draw();
    }else{
        $('#products-table').DataTable().column(4).search($('#kt_datatable_search_query1 option:selected').html()).draw();
